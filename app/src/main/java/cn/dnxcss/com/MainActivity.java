...
import com.vitas.cn.tab.BadgeView;
import com.vitas.cn.tab.XTabItem;
import com.vitas.cn.tab.XTabLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
      ...
      //  tabLayoutFour.addView(xTabItem.mCustomLayout);


        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("主页"),0);
        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("侧拉"),1);
        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("详情"),2);
        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("哈哈"),3);
        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("呵呵"),4);
        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("手册"),5);
        tabLayoutFour.addTab(tabLayoutFour.newTab().setIcon(R.drawable.badge_background).setText("反倒"),6);
      ...
      //  tabLayoutFour.setupWithViewPager(viewPager);
        ...
        tabLayoutFive.addOnTabSelectedListener(new XTabLayout.OnTabSelectedListener() {
            @Override
            public void onTabSelected(XTabLayout.Tab tab) {
                int position = tab.getPosition();

                Log.i("GGG","onTabSelected "+position);
            }

            @Override
            public void onTabUnselected(XTabLayout.Tab tab) {
                int position = tab.getPosition();
                Log.i("GGG","onTabUnselected "+position);
            }

            @Override
            public void onTabReselected(XTabLayout.Tab tab) {
                int position = tab.getPosition();
                Log.i("GGG","onTabReselected "+position);
            }
        });
